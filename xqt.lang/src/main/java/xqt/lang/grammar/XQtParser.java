...
public class XQtParser extends Parser {
	...
	public static final int
		...
		PLOT=45, TYPE=46, Boolean=47, String=48, Byte=49, Integer=50, Long=51, 
		Real=52, Date=53, EQ=54, NotEQ=55, GT=56, GTEQ=57, LT=58, LTEQ=59, LIKE=60, 
		PLUS=61, MINUS=62, NEGATE=63, MULT=64, DIV=65, MOD=66, POW=67, NOT=68, 
		ASN=69, AOR=70, AAND=71, COMMA=72, UNDERSCORE=73, LPAR=74, RPAR=75, DOT=76, 
		LCUR=77, RCUR=78, DCOLON=79, COLON=80, OR=81, AND=82, RELATIONSHIP=83, 
		RELATION_FW=84, RELATION_RW=85, RELATION_UN=86, RELATION_BI=87, CHAR=88, 
		STRING=89, LINE_COMMENT=90, COMMENT=91, NEWLINE=92, WS=93, ID=94, BOOLEAN=95, 
		DATE=96, UINT=97, INT=98, FLOAT=99;
	...
	public final ProjectionClauseContext projectionClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(272); match(PERSPECTIVE);
			setState(273); ((ProjectionClauseContext)_localctx).perspectiveName = simpleIdentifier();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final JoinedSourceContext joinedSource() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(283); simpleSource();
			setState(284); joinDescription();
			setState(285); simpleSource();
			setState(286); match(ON);
			setState(287); joinSpecification();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SimpleSourceContext simpleSource() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(295); bindingRef();
			setState(296); match(DOT);
			setState(297); containerRef();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final AnchorClauseContext anchorClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(309); match(ANCHOR);
			setState(312);
			_la = _input.LA(1);
			if (_la==START) {
				{
				setState(310); match(START);
				setState(311); ((AnchorClauseContext)_localctx).startAnchor = searchPhrase();
				}
			}
			...
			if (_la==STOP) {
				{
				setState(314); match(STOP);
				setState(315); ((AnchorClauseContext)_localctx).stopAnchor = searchPhrase();
				}
			}
	...
	public final FilterClauseContext filterClause() throws RecognitionException {
		...
		try {
			...
			setState(319); match(LPAR);
			setState(320); searchPhrase();
			setState(321); match(RPAR);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OrderClauseContext orderClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(323); match(ORDERBY);
			setState(324); sortSpecification();
			setState(329);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
				...
				setState(326); sortSpecification();
				}
				}
				setState(331);
				_errHandler.sync(this);
	...
	public final SortSpecificationContext sortSpecification() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(332); sortKey();
			setState(334);
			_la = _input.LA(1);
			if (_la==ASC || _la==DESC) {
				{
				setState(333); sortOrder();
				}
			}
	...
	public final NullOrderContext nullOrder() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(343); match(NULL);
				setState(344); match(FIRST);
				}
				break;
	...
	public final LimitClauseContext limitClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(349); match(LIMIT);
			setState(352);
			_la = _input.LA(1);
			if (_la==SKIP) {
				{
				setState(350); match(SKIP);
				setState(351); ((LimitClauseContext)_localctx).skip = match(UINT);
				}
			}
			...
			if (_la==TAKE) {
				{
				setState(354); match(TAKE);
				setState(355); ((LimitClauseContext)_localctx).take = match(UINT);
				}
			}
	...
	public final GroupClauseContext groupClause() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(358); match(GROUPBY);
			setState(359); simpleIdentifier();
			setState(364);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==COMMA) {
	...
	public final SearchPhraseContext searchPhrase() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(369); ((SearchPhraseContext)_localctx).phrase = expression(0);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(376); ((Expression_negateContext)_localctx).op = match(NEGATE);
				setState(377); ((Expression_negateContext)_localctx).operand = expression(13);
				}
				break;
			...
			case 2:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(378); ((Expression_notContext)_localctx).op = match(NOT);
				setState(379); ((Expression_notContext)_localctx).operand = expression(7);
				}
				break;
			...
			case 3:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(380); ((Expression_functionContext)_localctx).operand = function();
				}
				break;
			...
			case 4:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(381); match(LPAR);
				setState(382); ((Expression_nestContext)_localctx).operand = expression(0);
			...
			case 5:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(385); ((Expression_valueContext)_localctx).operand = value();
				}
				break;
			...
			case 6:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(386); ((Expression_idExprContext)_localctx).operand = idExpr();
				}
				break;
			...
			case 7:
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(387); ((Expression_smartContext)_localctx).operand = smartId();
				}
				break;
			}
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(391); ((Expression_powerContext)_localctx).op = match(POW);
						setState(392); ((Expression_powerContext)_localctx).y = expression(15);
						}
						break;
					...
					case 2:
						...
						consume();
						setState(395); ((Expression_multContext)_localctx).right = expression(13);
						}
						break;
					...
					case 3:
						...
						consume();
						setState(398); ((Expression_addContext)_localctx).right = expression(12);
						}
						break;
					...
					case 4:
						...
						consume();
						setState(401); ((Expression_aAndOrContext)_localctx).right = expression(11);
						}
						break;
					...
					case 5:
						...
						consume();
						setState(404); ((Expression_compareContext)_localctx).right = expression(10);
						}
						break;
					...
					case 6:
						...
						consume();
						setState(407); ((Expression_andOrContext)_localctx).right = expression(7);
						}
						break;
					...
					case 7:
						...
						if (_la==NoT) {
							{
							setState(410); ((Expression_isContext)_localctx).not = match(NoT);
							}
						}
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				enterOuterAlt(_localctx, 1);
				{
				setState(419); simpleIdentifier();
				setState(420); match(LPAR);
				setState(429);
				_la = _input.LA(1);
				if (((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & ((1L << (NEGATE - 63)) | (1L << (NOT - 63)) | (1L << (LPAR - 63)) | (1L << (STRING - 63)) | (1L << (ID - 63)) | (1L << (BOOLEAN - 63)) | (1L << (DATE - 63)) | (1L << (UINT - 63)) | (1L << (INT - 63)) | (1L << (FLOAT - 63)))) != 0)) {
					{
					setState(421); argument();
					setState(426);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
			...
			case 2:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(433); packagedIdentifier();
				setState(434); match(LPAR);
				setState(443);
				_la = _input.LA(1);
				if (((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & ((1L << (NEGATE - 63)) | (1L << (NOT - 63)) | (1L << (LPAR - 63)) | (1L << (STRING - 63)) | (1L << (ID - 63)) | (1L << (BOOLEAN - 63)) | (1L << (DATE - 63)) | (1L << (UINT - 63)) | (1L << (INT - 63)) | (1L << (FLOAT - 63)))) != 0)) {
					{
					setState(435); argument();
					setState(440);
					_errHandler.sync(this);
					_la = _input.LA(1);
					while (_la==COMMA) {
	...
	public final PackagedIdentifierContext packagedIdentifier() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(451); ((PackagedIdentifierContext)_localctx).packageId = match(ID);
			setState(452); match(DOT);
			setState(453); ((PackagedIdentifierContext)_localctx).id = match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SmartIdContext smartId() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(457); dataType();
				setState(458); match(DCOLON);
				setState(459); semanticKey();
				}
				break;
			...
			case 2:
				...
				setState(462); match(DCOLON);
				setState(463); semanticKey();
				}
				break;
	...
	public final ValueContext value() throws RecognitionException {
		...
		try {
			...
			setState(474);
			_la = _input.LA(1);
			if ( !(((((_la - 89)) & ~0x3f) == 0 && ((1L << (_la - 89)) & ((1L << (STRING - 89)) | (1L << (BOOLEAN - 89)) | (1L << (DATE - 89)) | (1L << (UINT - 89)) | (1L << (INT - 89)) | (1L << (FLOAT - 89)))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			consume();
			}
	...
	public final IdExprContext idExpr() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				enterOuterAlt(_localctx, 2);
				{
				setState(477); qualifiedIdentifier();
				}
				break;
			}
		}
	...
	public final VersionSelectorContext versionSelector() throws RecognitionException {
		...
		try {
			...
			case STRING:
				enterOuterAlt(_localctx, 1);
				{
				setState(480); labelVersionSelector();
				}
				break;
			case INT:
				enterOuterAlt(_localctx, 2);
				{
				setState(481); sequenceVersionSelector();
				}
				break;
			default:
				throw new NoViableAltException(this);
		...
		try {
			...
			case 1:
				...
				do {
					{
					{
					setState(503); match(RELATIONSHIP);
					setState(504); pathEntity();
					}
					}
					setState(507); 
					_errHandler.sync(this);
			...
			case 2:
				...
				{
				setState(521); match(RELATIONSHIP);
				setState(522); pathEntity();
				}
				setState(526);
				_la = _input.LA(1);
				if (_la==3) {
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(528); pathEntity();
				setState(531);
				_la = _input.LA(1);
				if (_la==3) {
					{
					setState(529); match(3);
					setState(530); pathAttribute();
					}
				}
				...
				do {
					{
					{
					setState(533); match(RELATIONSHIP);
					setState(534); pathEntity();
					}
					}
					setState(537); 
					_errHandler.sync(this);
	...
	public static final String _serializedATN =
		...
		"\64\3\65\3\65\3\65\6\65\u01f3\n\65\r\65\16\65\u01f4\3\66\3\66\3\67\3\67"+
		"\3\67\6\67\u01fc\n\67\r\67\16\67\u01fd\3\67\3\67\5\67\u0202\n\67\3\67"+
		"\3\67\3\67\7\67\u0207\n\67\f\67\16\67\u020a\13\67\3\67\3\67\3\67\3\67"+
		"\3\67\5\67\u0211\n\67\3\67\3\67\3\67\5\67\u0216\n\67\3\67\3\67\6\67\u021a"+
		"\n\67\r\67\16\67\u021b\3\67\3\67\3\67\3\67\5\67\u0222\n\67\38\38\39\3"+
		"9\39\2\3L:\2\4\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,.\60\62\64\66"+
		"8:<>@BDFHJLNPRTVXZ\\^`bdfhjlnp\2\20\3\2\27\30\3\28>\4\2``cc\3\2!\"\3\2"+
		"BD\3\2?@\3\2HI\3\2ST\4\2##,.\3\2\61\67\4\2[[ae\4\2\26\26[[\4\2\3\3\6\7"+
		"\4\2``dd\u0236\2r\3\2\2\2\4w\3\2\2\2\6\u0093\3\2\2\2\b\u00a1\3\2\2\2\n"+
		"\u00af\3\2\2\2\f\u00c3\3\2\2\2\16\u00d9\3\2\2\2\20\u00db\3\2\2\2\22\u00dd"+
		"\3\2\2\2\24\u00e1\3\2\2\2\26\u00e3\3\2\2\2\30\u00fd\3\2\2\2\32\u010c\3"+
		"\2\2\2\34\u0110\3\2\2\2\36\u0112\3\2\2\2 \u0115\3\2\2\2\"\u011b\3\2\2"+
		"\2$\u011d\3\2\2\2&\u0123\3\2\2\2(\u0125\3\2\2\2*\u0129\3\2\2\2,\u012d"+
		"\3\2\2\2.\u012f\3\2\2\2\60\u0135\3\2\2\2\62\u0137\3\2\2\2\64\u0140\3\2"+
		"\2\2\66\u0145\3\2\2\28\u014e\3\2\2\2:\u0155\3\2\2\2<\u0157\3\2\2\2>\u015d"+
